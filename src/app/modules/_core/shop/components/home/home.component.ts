...
import {FacebookAccount, GoogleAccount, ProductCategory, ProductSlide, UserAccount} from '@gw-models';
import {ShareMessageService, ShareProductCategoryService, ShareUserAccountService, ShareUserProfileService} from '@gw-services/shared';
