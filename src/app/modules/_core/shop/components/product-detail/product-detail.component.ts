...
import {
  ...
  ProductRate,
  ReplyOnProductFeedback,
  ReplyOnProductFeedbackReaction,
  ShoppingCart,
  UserProfile
} from '@gw-models';
import {ShareProductService, ShareUserProfileService} from '@gw-services/shared';
import {Router} from '@angular/router';
import {
  ProductFeedbackReactionService,
  ProductFeedbackService,
  ProductRateService,
  ReplyOnProductFeedbackReactionService,
  ReplyOnProductFeedbackService
